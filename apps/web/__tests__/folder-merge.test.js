...
describe('Folder Merge Logic', () => {
  describe('mergeBookmarks with folders', () => {
    ...
    it('should update existing folders with incoming data (incoming wins)', () => {
      ...
      const incoming = [
        { type: 'folder', title: 'Work', folderPath: 'Bookmarks Bar', index: 5, id: 'folder-1-new' },
      ];
    ...
    it('should handle mixed bookmarks and folders', () => {
      const existing = [
        { type: 'bookmark', url: 'https://example.com', title: 'Example', folderPath: 'Bookmarks Bar', index: 0, dateAdded: 1000 },
        { type: 'folder', title: 'Work', folderPath: 'Bookmarks Bar', index: 1 },
      ];
      const incoming = [
        { type: 'bookmark', url: 'https://new.com', title: 'New', folderPath: 'Bookmarks Bar', index: 2, dateAdded: 2000 },
    ...
    it('should handle nested folders correctly', () => {
      ...
      const parent = result.merged.find(f => f.title === 'Parent' && f.folderPath === 'Bookmarks Bar');
    ...
    it('should not lose folders when merging', () => {
      const existing = [
        ...
        { type: 'bookmark', url: 'https://existing.com', title: 'Existing', folderPath: 'Bookmarks Bar', index: 1, dateAdded: 1000 },
      ];
      const incoming = [
        { type: 'bookmark', url: 'https://new.com', title: 'New', folderPath: 'Bookmarks Bar', index: 2, dateAdded: 2000 },
      ];
      ...
      const existingFolder = result.merged.find(f => f.type === 'folder' && f.title === 'Existing Folder');
    ...
    it('should handle empty incoming data', () => {
      const existing = [
        { type: 'folder', title: 'Work', folderPath: 'Bookmarks Bar', index: 0 },
        { type: 'bookmark', url: 'https://example.com', title: 'Example', folderPath: 'Bookmarks Bar', index: 1, dateAdded: 1000 },
      ];
      const incoming = [];
    ...
    it('should preserve original ID when updating folder', () => {
      const existing = [
        { type: 'folder', title: 'Work', folderPath: 'Bookmarks Bar', index: 0, id: 'original-id-123' },
      ];
      const incoming = [
...
describe('Folder Index Preservation', () => {
  ...
  it('should handle folder moved to end of list', () => {
    const existing = [
      ...
      { type: 'bookmark', url: 'https://a.com', title: 'A', folderPath: 'Bookmarks Bar', index: 1, dateAdded: 1000 },
      { type: 'bookmark', url: 'https://b.com', title: 'B', folderPath: 'Bookmarks Bar', index: 2, dateAdded: 1000 },
    ];
    const incoming = [
      { type: 'bookmark', url: 'https://a.com', title: 'A', folderPath: 'Bookmarks Bar', index: 0, dateAdded: 2000 },
      { type: 'bookmark', url: 'https://b.com', title: 'B', folderPath: 'Bookmarks Bar', index: 1, dateAdded: 2000 },
