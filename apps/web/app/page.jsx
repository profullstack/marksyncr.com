  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-baseline">
        ...
        {!isFree && <span className="ml-1 text-slate-600">/{isYearly ? 'year' : 'month'}</span>}
      </div>
      {!isFree && isYearly && yearlyPrice && (
        <p className="mt-1 text-xs text-green-600 font-medium">
          Save{' '}
          {Math.round(
            (1 - parseInt(yearlyPrice.replace('$', '')) / (parseInt(price.replace('$', '')) * 12)) *
              100
          )}
          % vs monthly
        </p>
  ...
  return (
    <div className="gradient-bg">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="#features" className="btn-outline px-8 py-3 text-base">
              Learn More
            </Link>
          </div>
      ...
      <section id="sources" className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900">Choose Your Storage</h2>
            <p className="mt-4 text-lg text-slate-600">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-primary-600 px-8 py-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-primary-100">
              Join thousands of users who keep their bookmarks in sync across all their browsers and
              devices.
            </p>
            <Link
              href="/signup"
