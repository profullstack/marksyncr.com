/**
 * GitHub OAuth Connection Route
 *
 * Initiates GitHub OAuth flow for connecting GitHub as a sync source.
 */
  ...
  try {
    ...
    if (!clientId) {
      ...
      return NextResponse.redirect(
        new URL('/dashboard?error=github_not_configured', process.env.NEXT_PUBLIC_APP_URL)
      );
    }
