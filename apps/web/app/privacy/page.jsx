        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="mb-4 text-slate-600">
              MarkSyncr (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to
              protecting your privacy. This Privacy Policy explains how we collect, use, disclose,
              and safeguard your information when you use our browser extension and web service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-slate-600">
              When you create an account, we collect your email address and, if you choose OAuth
              login, basic profile information from your identity provider (GitHub or Google).
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-slate-600">
              ...
              information is stored securely using Supabase, which provides encryption at rest and
              in transit.
            </p>
            <p className="mb-4 text-slate-600">
          ...
          <section className="mb-8">
            ...
            <ul className="mb-4 list-disc pl-6 text-slate-600">
              ...
              <li className="mb-2">
                <strong>GitHub, Dropbox, Google Drive</strong> - Optional storage providers
              </li>
            </ul>
            <p className="mb-4 text-slate-600">
              Each of these services has their own privacy policies that govern their use of your
              data.
            </p>
          </section>
